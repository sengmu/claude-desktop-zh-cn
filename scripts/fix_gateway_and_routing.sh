...
if cfg_path.exists():
    ...
    mapping["claude-haiku-4-5-20251001"] = "gemini-3-flash"
    mapping["claude-sonnet-4-5"] = "gemini-3-pro-high"
    mapping["claude-opus-4"] = "gemini-3-pro-high"
    mapping["claude-opus-4-5-20251101"] = "gemini-3-pro-high"
    mapping["claude-opus-4-5-thinking"] = "gemini-3-pro-high"
    mapping["claude-opus-4-6"] = "gemini-3-pro-high"
    mapping["claude-opus-4-8"] = "gemini-3-pro-high"
    mapping["claude-opus-4-8[1m]"] = "gemini-3-pro-high"
    mapping["claude-sonnet-4-5[1m]"] = "gemini-3-pro-high"
    ...
    mapping["claude-3-5-sonnet-20240620"] = "gemini-3-pro-high"
